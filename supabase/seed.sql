...
insert into game (id, name, intro_description,
                  descriptions,
                  min_players, max_players, activity_level, alcohol_level, minutes, game_type_id, game_category_id, player_group_type_id, game_audience_id)
